        ...
        <>
            ...
            <form className="form" onSubmit={e => e.preventDefault()}>
                ...
                <label className="form__label" htmlFor="username">
                    Kullanıcı Adı: <span className="nowrap">[3-20 letters]</span></label>
                <input
                ...
                <label className="form__label" htmlFor="password">
                    Şifre: <span className="nowrap">[empty = no change]</span> <span className="nowrap">[4-12 chars incl. !@#$%]</span></label>
                <input
